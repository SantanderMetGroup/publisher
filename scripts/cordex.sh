...
find /oceano/gmeteo/WORK/PROYECTOS/2020_C3S_34d/synda/data/cordex -type f | sed 200q | python ncml.py --adapter CordexNcmlAdapter --dest tests/cordex/tds-content/public
